...
public object TransformNLAssimilation : ITransformer {
    public override fun transform(
        ...
        val ㄴㄹ이덧나는조건 =
            currentSyllable.hasJongseong() && nextSyllable.choseong == 'ㅇ' && nextSyllable.jungseong in PronounConstants.ㄴㄹ이_덧나는_후속음절_모음
